...
void *__kvmalloc_node_noprof(DECL_BUCKET_PARAMS(size, b), unsigned long align, gfp_t flags, int node) __alloc_size(1);
...
#define kvmalloc_array_noprof(_n,_s,_f)		kvmalloc_array_node_noprof(_n,_s,1,_f,NUMA_NO_NODE)
#define kvcalloc_node_noprof(_n,_s,_a,_f,_node)	kvmalloc_array_node_noprof(_n,_s,_a,(_f)|__GFP_ZERO,_node)
...
void *kvrealloc_node_noprof(const void *p, size_t size, unsigned long align, gfp_t flags, int nid) __realloc_size(2);
